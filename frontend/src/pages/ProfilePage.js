...
function ProfilePage() {
  ...
  const getLevelBadge = (level) => {
    if (level >= 50) return { name: 'ðŸ’Ž Diamond', color: '#B9F2FF' };
    if (level >= 30) return { name: 'ðŸ¥‡ Gold', color: '#FFD700' };
    if (level >= 15) return { name: 'ðŸ¥ˆ Silver', color: '#C0C0C0' };
    return { name: 'ðŸ¥‰ Bronze', color: '#CD7F32' };
  };
        ...
        <div className="edit-modal-overlay" onClick={handleCloseEdit}>
          <div className="edit-modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="edit-form-group">
              ...
              <small>ðŸ“± Select photo from gallery or camera (Max 5MB)</small>
            </div>
            ...
            <div className="edit-form-group">
              ...
              />
              <small>âš ï¸ Can change twice every 3 months</small>
            </div>
            ...
            <div className="edit-form-group">
              ...
              <textarea
                ...
                rows="4"
              />
              <small>âœ… Unlimited changes allowed</small>
            </div>
